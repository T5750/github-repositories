 ...
 * when the {@link java.beans.Introspector} constructs
 * a {@link java.beans.PropertyDescriptor} or {@link java.beans.EventSetDescriptor}
 * classes associated with the annotated code element.
 * A {@code true} value for the "transient" attribute
 * indicates to encoders derived from {@link java.beans.Encoder}
 * that this feature should be ignored.
 * <p/>
 * The {@code Transient} annotation may be be used
 * in any of the methods that are involved
 * in a {@link java.beans.FeatureDescriptor} subclass
 ...
 * In all cases, the {@link java.beans.Introspector} decides
