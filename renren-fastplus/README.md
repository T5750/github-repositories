...
- app is not completed!
    - register: ```http://localhost:8080/renren-fastplus/app/register?mobile=18888888888&password=123456```
    - login: ```http://localhost:8080/renren-fastplus/app/login?mobile=18888888888&password=123456```
    - userInfo: ```http://localhost:8080/renren-fastplus/app/userInfo```
    - userId: ```http://localhost:8080/renren-fastplus/app/userId```
    - notToken: ```http://localhost:8080/renren-fastplus/app/notToken```

## References
- [renren-fastplus](https://gitee.com/babaio/renren-fastplus)
