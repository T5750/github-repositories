    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("batch set: "
                    + client.batchSet(objInfo, keyValues, failKeys, (int)(System.currentTimeMillis() / 1000) + 300)
                    + failKeys);
                System.out.println("batch get: "
                    + client.batchGet(objInfo, keys, failKeys, (int)(System.currentTimeMillis() / 1000) + 30)
                    + failKeys);

                // System.out.println("after batch set, sub keys: " +
                // java.util.Arrays.toString(client.getSubKeys(objInfo)));
