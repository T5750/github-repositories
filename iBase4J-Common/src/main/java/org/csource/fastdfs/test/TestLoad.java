    ...
    */
    public static class UploadThread extends Thread {
        ...
        public void run() {
            ...
            System.out.println(
                "upload thread " + this.thread_index + " exit, total_upload_count: " + TestLoad.total_upload_count
                    + ", success_upload_count: " + TestLoad.success_upload_count + ", total_download_count: "
