...
public class OrderBookBizImpl implements OrderBookBiz {
	...
	public void add(OrderBookVo orderBookVo) {
		...
		while (iterator.hasNext()) {
			Map.Entry<String, String[]> form = (Map.Entry<String, String[]>) iterator
					.next();
	...
	public void update(ChangedItems changedItems, String staffId) {
		...
		List<ChangedItems.AlterItem> alterItemList = changedItems
				.getAlterItemList();
		String bookTitle;
		String isbn;
		Iterator iterator = alterItemList.iterator();
		while (iterator.hasNext()) {
			ChangedItems.AlterItem alterItem = (ChangedItems.AlterItem) iterator
					.next();
		...
		List<ChangedItems.DeleteItem> deleteItemList = changedItems
				.getDeleteItemList();
		iterator = deleteItemList.iterator();
		while (iterator.hasNext()) {
			ChangedItems.DeleteItem deleteItem = (ChangedItems.DeleteItem) iterator
					.next();
	...
	public void audit(List<OrderBookReviewVo> orderBookReviewVoList) {
		...
		while (iterator.hasNext()) {
			OrderBookReviewVo orderBookReviewVo = (OrderBookReviewVo) iterator
					.next();
	...
	public List<OrderBookReviewVo> findAllNotReviewedBook() {
		List<OrderBookReviewVo> orderBookReviewVoList = orderBookDao
				.findAllNotReviewedBook();
		Iterator iterator = orderBookReviewVoList.iterator();
		while (iterator.hasNext()) {
